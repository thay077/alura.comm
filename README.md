...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css?family=Inter:wght@400;700&display-swap" rel="stylesheet">
</head>
...
<p class=" descricao_texto">Aproveite a tela grande da TV ou assista no tablet, laptop,
celular e outros aparelhos. Nossa seleção de cursos não para de crescer.</p>
<section class="container secundario">
<div class="container descricao">
<p class="descricao texto">
</p>
Só o Combo+ oferece Alura e Alura Língua juntos para você ter acesso a cursos de diversas
...
img src="img/Telas.png" alt="Tela do alura e alura lingua" class="secundario_imagem">
</section>
<section class="container secundario">
...
<h3 class="lista item">Celular</h3>
</li>
</ul>
</section>
</body>
